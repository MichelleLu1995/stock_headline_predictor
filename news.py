...
newsdata = api.search(q='Blackrock', begin_date = start_date,
                               end_date = end_date,
                              fq='headline:(Blackrock) OR body:(Blackrock) OR subject:(Blackrock) and source:(Reuters AP The New York Times)',
#                              fq='headline:(Blackrock) or body:(Blackrock)',
                              page = 5,
                              facet_filter = True)
...
#for i in range(0,1):
#    newsdata = api.search(q='BlackRock',
#                       begin_date = start_date,
#                       end_date = end_date,
#                      # fq = "'source':['Reuters','AP', 'The New York Times']", 
#                      #fq = "'headline:' + company", 
#                      fq='headline:(Blackrock) OR subject:(Blackrock) AND source:(Reuters AP The New York Times)',
